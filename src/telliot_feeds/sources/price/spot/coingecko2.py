...
class CoinGeckoSpotPriceService2(WebPriceService):
...
@dataclass
class CoinGeckoSpotPriceSource2(PriceSource):
    asset: str = ""
    currency: str = ""
    service: CoinGeckoSpotPriceService2 = field(default_factory=CoinGeckoSpotPriceService2, init=False)
